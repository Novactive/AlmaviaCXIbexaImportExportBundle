...
class ComponentOptions
{
    ...
    /**
     * @param callable(ComponentReference $componentReference, ?ComponentOptions $runtimeProcessConfiguration): ComponentInterface<ComponentOptions> $buildComponentCallback
