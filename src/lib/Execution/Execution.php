...
class Execution
{
     ...
     *     fetch="EXTRA_LAZY"
     * )
     * @ORM\JoinColumn(name="workflow_state_id", referencedColumnName="id", nullable=true)
     */
    protected ?WorkflowState $workflowState = null;
    ...
    {
        return $this->workflowState ?? new WorkflowState();
    }
