...
class WorkflowConfiguration
{
    ...
    public function addProcessor(string $id, string $class, ProcessorOptions $options = null): void
    {
        ...
        $this->processConfiguration->addProcessor($id, new ComponentReference($class, $options));
    }
